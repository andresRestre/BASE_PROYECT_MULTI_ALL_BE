...
func SeedMenus(db *gorm.DB) error {
	// Auto-update legacy routes to full routes in existing database records
	_ = db.Exec("UPDATE administrative.menus SET route = '/access-control/users' WHERE route = '/users' OR id = 1")
	_ = db.Exec("UPDATE administrative.menus SET route = '/access-control/companies' WHERE route = '/companies' OR id = 2")
	_ = db.Exec("UPDATE administrative.menus SET route = '/access-control/roles' WHERE route = '/roles' OR id = 3")
	_ = db.Exec("UPDATE administrative.menus SET route = '/access-control/menus' WHERE route = '/menus' OR id = 4")
	_ = db.Exec("UPDATE administrative.menus SET route = '/inventory/categories' WHERE route = '/categories' OR id = 6")
	_ = db.Exec("UPDATE administrative.menus SET route = '/inventory/items' WHERE route = '/items' OR id = 7")
	...
	menus := []menuDomain.Menu{
		...
		{ID: 1, Label: "Usuarios", LabelEN: "Users", LabelFR: "Utilisateurs", Route: "/access-control/users", Icon: "people_rounded", SortOrder: 1, IsActive: true, ParentID: &accessControlID},
		{ID: 2, Label: "Empresas", LabelEN: "Companies", LabelFR: "Entreprises", Route: "/access-control/companies", Icon: "business_rounded", SortOrder: 2, IsActive: true, ParentID: &accessControlID},
		{ID: 3, Label: "Roles", LabelEN: "Roles", LabelFR: "Rôles", Route: "/access-control/roles", Icon: "admin_panel_settings_rounded", SortOrder: 3, IsActive: true, ParentID: &accessControlID},
		{ID: 4, Label: "Menús", LabelEN: "Menus", LabelFR: "Menus", Route: "/access-control/menus", Icon: "menu_rounded", SortOrder: 4, IsActive: true, ParentID: &accessControlID},
		...
		{ID: 6, Label: "Categorías", LabelEN: "Categories", LabelFR: "Catégories", Route: "/inventory/categories", Icon: "category_rounded", SortOrder: 11, IsActive: true, ParentID: &inventariosID},
		{ID: 7, Label: "Artículos", LabelEN: "Items", LabelFR: "Articles", Route: "/inventory/items", Icon: "inventory_rounded", SortOrder: 12, IsActive: true, ParentID: &inventariosID},
